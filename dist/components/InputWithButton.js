...
var MessageInput = function (_a) {
    var onSend = _a.onSend, loading = _a.loading;
    ...
    return (_jsxs("div", __assign({ className: "input-container" }, { children: [_jsx("input", { ref: inputRef, disabled: loading, type: "text", value: inputValue, onChange: handleChange, onKeyDown: handleKeyDown, placeholder: loading ? "Ожидайте ответ" : "Введите сообщение", className: "input-field" }), _jsx("button", __assign({ className: "submit-button ".concat(inputValue.length > 0 ? 'visible' : ''), onClick: handleSubmit, disabled: loading }, { children: _jsx("img", { src: arrow, alt: 'arrow', className: 'submit-button__arrow' }) }))] })));
};
